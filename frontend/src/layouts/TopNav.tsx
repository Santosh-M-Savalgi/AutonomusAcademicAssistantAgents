...
export function TopNav() {
  ...
  return (
    <header className="h-14 border-b border-surface-border flex items-center justify-between px-6 bg-surface/50 backdrop-blur-sm">
      {/* Left: Page title */}
      <div>
      ...
      <div className="flex items-center gap-3">
        {/* Search */}
        <button
          className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm text-text-muted bg-surface border border-surface-border hover:border-text-muted transition-colors"
          aria-label="Search"
        >
        ...
        <button
          className="p-2 rounded-md text-text-muted hover:text-text-secondary hover:bg-surface-hover transition-colors"
